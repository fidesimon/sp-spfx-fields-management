...
export default class FieldManagement extends React.Component<IFieldManagementProps, IFieldManagementState> {
  ...
  public render(): React.ReactElement<IFieldManagementProps> {
    ...
    /* This part of code is for further investigation on a better way of displaying fields.
              <DetailsList 
            items={ this.state.fieldsPlain }
            compact={ true }
            columns={ [{key:"Title", name:"Title", fieldName:"Title", minWidth:200}, {key:"TypeDisplayName", name:"TypeDisplayName", fieldName:"TypeDisplayName", minWidth:200}] }
  ...
  protected async _retrieveColumns(): Promise<any> {
    ...
    if(response.ok){
      ...
      if(responseJSON != null && responseJSON.value != null){
        ...
        //let plainFields : ISPField[] = responseJSON.value as ISPField[];
